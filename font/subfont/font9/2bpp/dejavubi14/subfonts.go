...
// X2580_2680 subfont, n=257, ▀▁▂▃▄▅▆▇█▉▊▋▌▍▎▏▐░▒▓▔▕▖▗▘▙▚▛▜▝▞▟■□▢▣▤▥▦▧▨▩▪▫▬▭▮▯
var X2580_2680 = &subfont.Subfont{
	First:  0x2580, // '▀'
	Last:   0x2680, // '⚀'
	Offset: 0,
	Data:   &X2580,
...
// X1e01_1ef3 subfont, n=243, ḁḂḃḄḅḆḇḈḉḊḋḌḍḎḏḐḑḒḓḔḕḖḗḘḙḚḛḜḝḞḟḠḡḢḣḤḥḦḧḨḩḪḫḬḭḮḯḰ
var X1e01_1ef3 = &subfont.Subfont{
	First:  0x1e01, // 'ḁ'
	Last:   0x1ef3, // 'ỳ'
	Offset: 0,
	Data:   &X1e01,
...
// X0101_01f3 subfont, n=243, āĂăĄąĆćĈĉĊċČčĎďĐđĒēĔĕĖėĘęĚěĜĝĞğĠġĢģĤĥĦħĨĩĪīĬĭĮįİ
var X0101_01f3 = &subfont.Subfont{
	First:  0x0101, // 'ā'
	Last:   0x01f3, // 'ǳ'
	Offset: 0,
	Data:   &X0101,
