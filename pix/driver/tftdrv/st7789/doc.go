...
// clock. The performance of a particular SPI bus depends on many factors which
// can probably be tuned for even higher speeds. The absolute upper limits are
// those given for the parallel interface below.
const (
	MaxSPIWriteClock = 15e6
