...
const akermanianSteppesPL = `Wpłynąłem na suchego przestwór oceanu, Wóz nurza się w zieloność i jak łódka brodzi, Śród fali łąk szumiących, śród kwiatów powodzi, Omijam koralowe ostrowy burzanu.
...
const akermanianSteppesEN = `I launch myself across the dry and open narrows, My carriage plunging into green as if a ketch, Floundering through the meadow flowers in the stretch. I pass an archipelago of coral yarrows.
...
func DrawText(disp *pixd.Display, n int) {
	...
	for i := 0; i != n; i++ {
		...
		clearAndPrint(a, fvga, akermanianSteppesPL)
	}
}
